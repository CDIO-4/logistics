...
import com.cdio4.logistics.domain.Price;
 ...
 * 
 * @see com.cdio4.logistics.domain.Price
...
public class PriceDAO {
	...
	public static final String PRICE_DISTANCE = "priceDistance";
	...
	public Price findById(java.lang.Integer id) {
		...
		try {
			Price instance = (Price) getCurrentSession().get(
					"com.cdio4.logistics.domain.Price", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Price> findByExample(Price instance) {
		...
		try {
			List<Price> results = (List<Price>) getCurrentSession()
					.createCriteria("com.cdio4.logistics.domain.Price")
	...
	public List<Price> findByTransportPrice(Object transportPrice) {
		return findByProperty(TRANSPORT_PRICE, transportPrice);
	}

	public List<Price> findByPriceDistance(Object priceDistance) {
		return findByProperty(PRICE_DISTANCE, priceDistance);
	}
